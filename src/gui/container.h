...
class BeWidgetContainer : public BeWidget
{
	...
	protected:
		...
		BeWidgetPtr addWidgetTextInput( const std::string& name, const Vector2i& pos, const Vector2i& dimensions, const std::string& textstring, const Vector2i& textpos, const BeCommand& cmds, EventProperty_Repeat repeat, unsigned int delay, const std::string& cvar  );
