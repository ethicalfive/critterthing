...
#include "modes/sams_mode.h" //Added by Ethical 
...
Evolution::Evolution(BeFilesystem& filesystem)
 ...
 , m_mode_round(settings->getCVarPtr("roundworld"))
  , m_mode_sam(settings->getCVarPtr("sams_mode"))
...
// 	if ( settings->getCVar("headless") == 0 )
	{
		...
		m_glwindow->create("Critterthing beta15 EXPERIMENTAL");
	...
	//	world->init();
		world->loadLastProfile();
		settings->setCVar("autoloadlastsaved", 1 ); //otherwise autoload statements later will fail if the last profile wasnt started with autoloading on
...
// 		world = new Concavefloor( m_graphicsSystem, filesystem, textverbosemessage );
	else if ( settings->getCVar("sams_mode") == 1 )
		world = new SamsMode( m_graphicsSystem, filesystem, textverbosemessage );
	else
		world = new WorldB( m_graphicsSystem, filesystem, textverbosemessage );
...
//		m_canvas->addWidget( "console", boost::shared_ptr<BeWidget>(new Console()) );  //Eth|cal
		...
		m_canvas->addWidget( "fitnesspanel", boost::shared_ptr<BeWidget>(new Fitnesspanel()) );
...
// 					glColor4f(1.0f, 1.0f, 1.0f, 0.0f);
	...
	// 					debugDrawer.setDebugMode(btIDebugDraw::DBG_DrawWireframe|btIDebugDraw::DBG_DrawAabb|btIDebugDraw::DBG_DrawText|btIDebugDraw::DBG_DrawConstraints | btIDebugDraw::DBG_DrawConstraintLimits);
					...
					{
						debugDrawer.setDebugMode(btIDebugDraw::DBG_FastWireframe|btIDebugDraw::DBG_DrawText|btIDebugDraw::DBG_DrawConstraintLimits|btIDebugDraw::DBG_EnableSatComparison);
					}
					else if (*drawdebug == 6)
					{
						debugDrawer.setDebugMode(btIDebugDraw::DBG_DrawContactPoints);
					}
						...
						if ( *drawscene == 1 || *drawdebug > 0  )
						{
							...
							if (!world->mouselook && !m_canvas->mouseFocus )
							{
								...
								if ( world->mouseRayHit )
								{
									...
									if ( world->mouseRayHitEntity->type == 0)  //Ethical - CRITTER BACKGROUND MOUSEOVER
									{
										if (1)
										{
										...
										glBegin(GL_QUADS);
										glVertex2i(world->mousex,        		world->mousey+120);
										glVertex2i(world->mousex,        	 	world->mousey-20);
										glVertex2i(world->mousex+170, 			world->mousey-20);
										glVertex2i(world->mousex+170, 			world->mousey+120);
										glEnd();
										glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
										glPopMatrix();
									...
									if ( world->mouseRayHitEntity->type == 1)  //Ethical - FOOD BACKGROUND MOUSEOVER
									{
										if (1)
										{
											glBlendFunc(GL_SRC_ALPHA,GL_ONE_MINUS_SRC_ALPHA);
										...
										// 	glTranslatef(0.5f, 0.5f, 0.0f); // pixel precision offset
										glBegin(GL_QUADS);
										glVertex2i(world->mousex,        		world->mousey+40);
										glVertex2i(world->mousex,        	 	world->mousey-20);
										glVertex2i(world->mousex+120, 			world->mousey-20);
										glVertex2i(world->mousex+120, 			world->mousey+40);
										glEnd();
										glColor4f(1.0f, 1.0f, 1.0f, 1.0f);
										glPopMatrix();
									...
									if ( world->mouseRayHitEntity->type == 1 )
									{
										...
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer, "lifetime");
										...
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer, "%1i", static_cast<const Food*>(world->mouseRayHitEntity)->totalFrames);
									...
									else if ( world->mouseRayHitEntity->type == 0 )
									{
										...
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer, "ADAM");										
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer, "%1i", c->genotype->adamdist);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer, "touchingFood");										
										Textprinter::Instance()->print(world->mousex+rmargindistance+rmargindistance, world->mousey+vspacer+vspacer+vspacer, "%1i", c->touchingFood);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer, "eat");										
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer, "%1i", c->eat);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer, "beingTouched");										
										Textprinter::Instance()->print(world->mousex+rmargindistance+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer, "%1i", c->beingTouched);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "touchingCritter");										
										Textprinter::Instance()->print(world->mousex+rmargindistance+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "%1i", c->touchingCritter);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "X");										
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "%1f", c->X);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "Y");										
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "%1f", c->Y);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "Z");										
										Textprinter::Instance()->print(world->mousex+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "%1f", c->Z);
										Textprinter::Instance()->print( world->mousex+margin, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "crittertype");										
										Textprinter::Instance()->print(world->mousex+rmargindistance+rmargindistance, world->mousey+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer+vspacer, "%1i", c->genotype->crittertype);
	...
	// 		Cdcommands::Instance()->quit();
		...
		if ( world->food_units.size() <= settings->getCVar("save_and_close_sim_at_x_food") && settings->getCVar("save_and_close_sim_at_x_food") )
		{
	//		cout << "..." << endl;
	// 		Cdcommands::Instance()->quit();
			settings->setCVar("save_and_close_sim_at_x_food", 0 );
