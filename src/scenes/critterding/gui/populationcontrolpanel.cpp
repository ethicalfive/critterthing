...
// 	row+=8;
	...
	// Ethicalfive
	addSettingmutator("population_eliminate_portion_toggle_exchange_rand", 0, 0);
	addSettingmutator("population_rand_toggle", 0, 0);
	

	row+=8;
	addSettingmutator("save_and_close_sim_at_x_food", 0, 0);
