...
Globalsettingspanel::Globalsettingspanel()
{
	...
	addSettingmutator("skybox_rotationZ", 0, 0);
 	addSettingmutator("skybox_scale", 0, 0);			//FIXME changing this does nothing
...
// 	addSettingmutator("drawscene", 0, 0);
	...
	row+=8; 
	addSection("Retina input factor", 0, 0);
	addSettingmutator("visionFactor", 0, 0);
	...
	row+=8;	
	addSettingcheckbox("critter_enablecarnivores", 0, 0);
	addSettingmutator("critter_mutate_carnivore", 0, 0);
	addSettingcheckbox("critter_enableomnivores", 0, 0);
	addSettingcheckbox("critter_enablepoison", 0, 0);
	row+=8;	
